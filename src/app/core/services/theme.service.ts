...
import { ColorPalette, ThemeMode, ThemeConfig, UserThemePreference, COLOR_PALETTES } from '../models/theme.model';
...
export class ThemeService {
  ...
  private loadTheme(): void {
    ...
    this.http.get<UserThemePreference>(this.API_URL).pipe(
      tap((preference) => {
  ...
  private saveTheme(): void {
    ...
    this.http.post<UserThemePreference>(this.API_URL, { theme }).pipe(
      catchError((error) => {
